        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-24">
          <div>
            ...
            <div className="space-y-4 text-muted-foreground leading-relaxed">
              <p>
                Founded in 2020, GOG ESPORTS (Gymnastik ohne Grenzen) emerged from a small group of passionate gamers who believed in a holistic approach to competitive gaming. The name, "Gymnastics Without Borders," reflects our core belief in mental and physical fitness as a key to unlocking digital potential.
              </p>
              <p>
